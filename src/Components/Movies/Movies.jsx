...
console.log(nums);
  async function getTrending(page){
    setisLoading(true)
    let {data}= await axios.get(`https://api.themoviedb.org/3/discover/movie?api_key=7b418cb7b7318c1309703aa026c3babb&sort_by=popularity.desc&include_adult=false&include_video=true&page=${page}`)
    setisLoading(false)
 ...
 {Movies?.map((item ,index)=>   <>
    ...
    <div key={index} className="col-md-3  my-3 shadoww">
    ...
    <h3 className='h5 py-2'>{item.title} </h3>
